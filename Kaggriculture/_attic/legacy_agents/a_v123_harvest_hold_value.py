"""v123 -- v122 plus hold-priced harvests for price-crashed crops.
...
v123 therefore prices a below-50 harvest at max(spot, hold_fraction * base)
instead of zero.  The floor is the agent's own selling reservation, so it is
