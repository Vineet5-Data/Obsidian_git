...
MAX_BUY_ORDERS = 5
WHEAT_BUY_MAX = 45
LOW_T_CAP = 2            # hard per-species cap for MILK/WOOL producers
...
def _plan(obs):
    ...
    # MILK (T=122) and WOOL (T=105) have the two lowest absorption thresholds
    # in the game, and WOOL falls off a square curve (af="sq").  A herd that
    # fills its species_cap with cows and sheep crashes the price of its own
    # output, so hold those two to a hard count and let poultry take the rest.
