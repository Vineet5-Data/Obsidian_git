...
def _plan(obs):
    ...
    if day >= 20:
        ...
        crop_cap_share = 0.62 if len(shops) < 2 else 0.68
    elif day <= 15:
        crop_cap_share = 0.58 if len(shops) < 2 else 0.65
    else:
        crop_cap_share = 0.48 if len(shops) < 2 else 0.55
