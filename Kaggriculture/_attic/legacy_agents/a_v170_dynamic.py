...
def animal_service_jobs(x, y, tile, step, spot):
    ...
    if step < FINAL_FARM_STEP and not tile.get("fed_today"):
        ...
        # V169: Value survival at a massive premium to prevent abandonment, and base normal feeding on base price
        feed_val = 500.0 if starving else 2.2 * max(product_price, MP[animal["prod"]]["base"] * 0.5)
