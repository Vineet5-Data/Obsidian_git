...
CROP_CAP_EARLY = 0.50   # share of the portfolio one crop may hold
CROP_CAP_LATE = 0.62
...
# i.e. the LAST callable bound in the module, ignoring its name.  Without this
# final binding Kaggle runs `_self_check` and every turn degrades to PASS.
