...
def _plan(obs):
    ...
    # ponytail: injected spec loading
    ACTIVE_SPEC = {"name": "91635004", "quadrants": 3, "land_days": [6, 10], "layout": {"PASTURE": 15, "COOP": 0, "CROP": 3}, "animals": {"SHEEP": 7, "COW": 8}, "animal_days": [0, 0, 0, 0, 1, 5, 6, 6, 7, 7, 8, 8, 10, 10, 11], "crops": {"MELON": 0.076, "WHEAT": 0.737, "STRAWBERRY": 0.157, "CARROT": 0.03}, "hire_curve": [3, 0, 3, 3, 3, 4, 4, 6, 8, 9, 10, 10, 10, 10, 10, 10, 14, 14, 14, 14, 12, 12, 12, 12, 12, 12, 12, 12, 12, 10], "fert_cadence": 58}
